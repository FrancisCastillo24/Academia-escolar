...
<div class="container mt-5 mb-5">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form action="{{ route('course.store') }}" method="post" class="p-4 border rounded shadow-sm bg-light">
                ...
                <div class="mb-4">
                    ...
                    <textarea 
                        ...
                        rows="3" 
                        placeholder="Escribe una breve descripción del curso">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('course.index') }}" class="btn btn-secondary px-4 py-2">Volver</a>
